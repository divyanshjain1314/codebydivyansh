            ...
            <Card className="border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 shadow-xl shadow-zinc-200/50 dark:shadow-none">
              <CardContent className="pt-8 pb-8 space-y-6">
                ...
                <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed">
                  I am open to freelance opportunities, full-time positions, or
                  interesting open-source projects. If you have a specific
                  proposal or just want to chat about tech, feel free to reach
                  out.
                </p>
                <div className="pt-4">
                  <Button
