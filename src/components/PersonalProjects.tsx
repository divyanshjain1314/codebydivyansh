...
const personalLabs = [
  {
    ...
    description:
      "A modern, responsive admin dashboard built with advanced Tailwind CSS layouts.",
  ...
  },
  {
    title: "Design Studio",
    description:
      "Creative landing page for a digital agency focusing on high-end typography and motion.",
  ...
  },
  {
    ...
    description:
      "Healthcare management UI for appointment scheduling and patient records.",
  ...
  },
  {
    ...
    description:
      "Interactive calendar tool for managing events and daily schedules with drag-drop features.",
  ...
  },
  {
    title: "LeadCRM.co",
    description:
      "Personal CRM project focused on lead tracking and business management logic.",
  ...
  },
  {
    ...
    description:
      "A utility tool to merge multiple PDF files directly in the browser.",
...
export default function PersonalProjects() {
  return (
    <section
      ...
      className="py-24 px-4 bg-zinc-50/50 dark:bg-zinc-950/50 transition-colors duration-300"
    >
        ...
        <div className="flex items-center gap-3 mb-12">
          ...
          <div>
            ...
            <p className="text-zinc-500 dark:text-zinc-400">
              Experimental projects and utility tools built for learning.
            </p>
          </div>
        </div>
                  ...
                  <div className="flex flex-wrap gap-2 mt-2">
                    {project.tags.map((tag) => (
                      <Badge
                        key={tag}
                        variant="secondary"
                        className="text-[10px] uppercase font-bold tracking-widest bg-zinc-100 dark:bg-zinc-800"
                      >
                        {tag}
                      </Badge>
                    ))}
